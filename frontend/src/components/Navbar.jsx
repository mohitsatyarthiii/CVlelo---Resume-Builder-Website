...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 h-20 bg-white/70 backdrop-blur-xl border-b border-violet-100/50 shadow-sm px-4 md:px-0">
      <div className="max-w-6xl mx-auto flex items-center justify-between h-full gap-5">
        ...
        <Link to="/" className="flex items-center gap-3 h-full">
          <div className="w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-200 overflow-hidden">
            <img
              src="/svg.png"
              alt="CVlelo Logo"
