...
import {DUMMY_RESUME_DATA, resumeTemplates} from '../utlis/data'
  ...
  return (
    <div className='max-w-7xl mx-auto px-4'>
        ...
        p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100'>
            ...
            <button className='w-full sm:w-auto flex items-center gap-3 px-6 py-3 bg-gradient-to-r
            from-violet-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 transition-all hover:shadow-xl'
