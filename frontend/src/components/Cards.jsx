...
export const TemplateCard = ({thumbnailImg, isSelected, onSelect}) => {
  ...
  return (
    <div className={`group h-auto md:h-[320px] flex flex-col bg-white border-2 overflow-hidden
      cursor-pointer transition-all duration-500 hover:sclae-105 hover:shadow-lg rounded-3xl
      ${
        isSelected ? 'border-violet-600 shadow-lg shadow-violet-200 bg-violet-50' :'border-gray-200 hover:border-violet-300' 
      }`}onClick={onSelect}>
        {thumbnailImg ? (
          <div className="relative w-full h-full overflow-hidden">
            <img src={thumbnailImg || '/placeholder.svg'} alt="template-review" className="
