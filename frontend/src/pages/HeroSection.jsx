        ...
        >
          ...
          <motion.div className="lg:w-1/2 mb-12 lg:mb-0" variants={fadeUp}>
            ...
            >
              <button
                onClick={handleCTA}
                className="px-8 py-3 bg-gradient-to-r from-pink-500 to-blue-500 text-white font-medium rounded-md hover:bg-red-600 transition-colors"
              >
                Create My Resume
              </button>
              <button
          ...
          >
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-2xl transition-all duration-500  w-full h-full flex items-center justify-center">
