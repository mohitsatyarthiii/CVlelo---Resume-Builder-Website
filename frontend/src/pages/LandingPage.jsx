      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          <div className={landingPageStyles.logoContainer}>
            ...
            <span className={landingPageStyles.logoText}>CVlelo</span>
          </div>
          {/**Mobile menu btn */}
          <button
            ...
            {user ? (
              <>
                <button
                  ...
                  className="relative inline-flex items-center justify-center px-5 py-2 rounded-full font-semibold text-white bg-gradient-to-r from-violet-600 to-fuchsia-600 shadow-md transition-transform duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-xl hover:shadow-fuchsia-500/40"
                >
                  Dashboard
                </button>
                <ProfileInfoCard />
          ...
          <div className={landingPageStyles.ctaContainer}>
            ...
            <div className={landingPageStyles.ctaCardContent}>
              ...
              <p className={landingPageStyles.ctaDescription}>
                ...
                with our expert-crafted resumes.
              </p>
              <button
